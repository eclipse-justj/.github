...
JustJ generates Java™ runtimes from sources like [jdk.java.net](https://jdk.java.net/) and [adoptium.net](https://adoptium.net/). If you discover vulnerabilities in the binaries released by JustJ, please 
report them to the corresponding upstream project. In cases where a new version addressing these vulnerabilities is available from an upstream project but hasn't yet been provided by JustJ, 
you may [open an issue](https://github.com/eclipse-justj/justj/issues) to request its inclusion.
